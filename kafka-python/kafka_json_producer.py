...
FILE_PATH = f"{os.getcwd()}\cardekho_dataset.csv"
columns = ['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
           'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
           'seats', 'selling_price']

API_KEY = 'UEGEE5RCOJXWYWMA'
ENDPOINT_SCHEMA_URL = 'https://psrc-3w372.australia-southeast1.gcp.confluent.cloud'
API_SECRET_KEY = 'LJvefklHF31OGsRi7tUSojj2Xsh/qLjLMJKLStIoSBcX7Kp60IkSbCxigoAk2Gpb'
BOOTSTRAP_SERVER = 'pkc-41p56.asia-south1.gcp.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'LHT5ITDJJJRWXKMB'
SCHEMA_REGISTRY_API_SECRET = 'TEdiBWML0xnZukTVAXTH4+HQgcKSe9dIb55CoBABJ4nw9s8C+zQimG5zvMZeHZXX'
